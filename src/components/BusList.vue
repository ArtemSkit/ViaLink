                  ...
                  <v-list-tile-content>
                    <v-list-tile-title>
                      <div class="opposite-sides-string-wrapper">
                        ...
                        <div class="opposite-sides-right">{{ item.busTime }}</div>
                      </div>
                    </v-list-tile-title>
                  </v-list-tile-content>
                </v-list-tile>
...
export default {
    data:() => ({
        items: [
            {busNumber: 443,
            busName: 'Loot and skip',
            busTime: '12:30'},
            {busNumber: 449,
            busName: 'Loot and skip',
            busTime: '12:30'},{busNumber: 444,
            busName: 'Loot and skip',
            busTime: '12:30'},{busNumber: 444,
            busName: 'Loot and skip',
            busTime: '12:30'},{busNumber: 44544,
            busName: 'Loot and skip',
            busTime: '12:30'},{busNumber: 443423,
            busName: 'Loot and skip',
            busTime: '12:30'},
        ]
    }),
